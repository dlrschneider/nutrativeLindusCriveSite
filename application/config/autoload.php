...
// CLASSES ABSTRATAS
require APPPATH . 'libraries/negocio/BusinessObject.php';

// EXCEÇÕES
require APPPATH . 'libraries/sistema/exception/ModelException.php';
require APPPATH . 'libraries/sistema/exception/NegocioException.php';
...
*/
$autoload['helper'] = array('form', 'url', 'view', 'view_admin', 'formato', 'combo');
